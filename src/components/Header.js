                ...
                <div className="top-bar">
                    <div className="flex-sb-m h-full w-full container">
                        ...
                        <div className="right-top-bar flex-w h-full">
                            <Translation>{t =>
                                <Link to="/" className="flex-c-m trans-04" style={{paddingLeft: "1.5vw", paddingRight: "1.5vw", fontFamily: 'Times New Roman', width: "10vw", maxWidth: "140px"}}>                                
                                     {t('FAQ')}
                                </Link>}    
                            </Translation> 

                            <Translation>{t =>
                                <Link to="/admin" className="flex-c-m trans-04" style={{paddingLeft: "1.5vw", paddingRight: "1.5vw", fontFamily: 'Times New Roman', width: "15vw", maxWidth: "220px"}}>
                                    {t('account')}
                                </Link>}
                            </Translation> 
                            
                            <Translation>{t =>
                                <span className="flex-c-m" style={{paddingLeft: "1.5vw", paddingRight: "0.5vw", fontFamily: 'Times New Roman', color: '#dcdcdc', width: "10vw", maxWidth: "120px"}}>
                                    {t('language')}: 
                                </span>}
                            </Translation> 
